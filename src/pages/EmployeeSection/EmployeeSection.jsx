...
function EmployeeSection() {
  ...
  const [isInfomationModalOpen, setIsInfomationModalOpen] = useState(false);
  ...
  const cancelLeaveManageCreditModal = () => {
    setIsLeaveCreditsModalOpen(value => !value);
  }

  const informationModalHandler = () => {
    setIsInfomationModalOpen(value => !value);
    setIsMounted(value => !value);
  }
  ...
  return (
    <>
                    ...
                    {Array.isArray(filteredUsers) &&
                      filteredUsers.map((element, index) => (
                        <tr key={index} className="text-center">
                          ...
                          <td className="py-6 px-4 flex justify-center items-center space-x-2">
                            <button
          ...
          <div className="bg-white p-8 rounded-md shadow-lg w-full max-w-lg overflow-y-auto max-h-80% ">
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-end space-x-4 mt-6">
                <button
                  type="button"
                  onClick={cancelLeaveManageCreditModal}
      ...
      {isInfomationModalOpen && (
        <Information name="Ok" information={message} onClick={informationModalHandler} />
      )}
